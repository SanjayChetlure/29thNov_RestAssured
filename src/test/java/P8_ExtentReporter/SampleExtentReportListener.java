...
public class SampleExtentReportListener implements ITestListener
{
    ...
    public void onStart(ITestContext context)        //it creates report template at the start of execution
    {
        ...
        sparkReporter = new ExtentSparkReporter("Reports/SampleReport.html");    //location of report
        ...
        extent.setSystemInfo("Release", "R1");
    }
